...
const isMainPage = props.currentPath === '/' || props.currentPath === '/fr/' || props.currentPath === '/en/';

const hasTransitioned = ref(false);
if (typeof window !== 'undefined') {
  hasTransitioned.value = sessionStorage.getItem('hasTransitioned') === 'true';
}

shouldPlayTransition.value = isMainPage && !hasTransitioned.value;
